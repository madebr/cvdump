...
class DbiStream(KaitaiStruct):
    def __init__(self, pdb_version, _io, _parent=None, _root=None):
    ...
    def _read(self):
        ...
        self.module_info = DbiStream.ModuleInfos(self.pdb_version, self.header.version_header, _io__raw_module_info, self, self._root)
    ...
    class ModuleInfoV20(KaitaiStruct):
        """generated by Visual C++ 2.10/2.20."""
        def __init__(self, _io, _parent=None, _root=None):
            super(DbiStream.ModuleInfoV20, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.section_contrib = DbiStream.SectionContribV20(self._io, self, self._root)
    ...
    class ModuleInfoV60(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.debug_info_stream = self._io.read_u2le()
            self.symbols_size = self._io.read_u4le()
            self.c11_line_size = self._io.read_u4le()
            self.c13_line_size = self._io.read_u4le()
            self.source_file_count = self._io.read_u2le()
            self.unused = self._io.read_u2le()
            self.source_filename_index = self._io.read_u4le()
    ...
    class ModuleInfos(KaitaiStruct):
        def __init__(self, pdb_version, dbi_header_version, _io, _parent=None, _root=None):
        ...
        def _read(self):
            if self.is_v20:
                ...
                while not self._io.is_eof():
                    self.entries_v20.append(DbiStream.ModuleInfoV20(self._io, self, self._root))
                    i += 1
        ...
        def _fetch_instances(self):
            ...
            if self.is_v20:
                pass
                for i in range(len(self.entries_v20)):
                    pass
                    self.entries_v20[i]._fetch_instances()
        ...
        def entries(self):
            ...
            self._m_entries = (self.entries_v20 if self.is_v20 else (self.entries_v50 if self.is_v50 else self.entries_v60))
            return getattr(self, '_m_entries', None)

        @property
        def is_v20(self):
            if hasattr(self, '_m_is_v20'):
                return self._m_is_v20

            self._m_is_v20 = self.pdb_version <= 19941610
            return getattr(self, '_m_is_v20', None)
        ...
        def is_v50(self):
            ...
            self._m_is_v50 =  (((not (self.is_v20))) and (self.dbi_header_version < 19970606)) 
        ...
        def section_contrib_version(self):
            ...
            self._m_section_contrib_version = (5 if self.is_v60 else (4 if self.is_v50 else (2 if self.is_v20 else -1)))
    ...
    class NewDebugInformationHeader(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.version_number_mspdb_dll = self._io.read_u2le()
            self.symbol_record_stream = self._io.read_u2le()
            self.build_number_mspdb_dll = self._io.read_u2le()
    ...
    class SectionContribV20(KaitaiStruct):
        """SC20 (dbicommon.h)."""
        def __init__(self, _io, _parent=None, _root=None):
            super(DbiStream.SectionContribV20, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class SectionContribs(KaitaiStruct):
        ...
        def _read(self):
            if self.is_v20:
                ...
                i = 0
                while not self._io.is_eof():
                    self.entries_v20.append(DbiStream.SectionContribV20(self._io, self, self._root))
                    i += 1
        ...
        def entries(self):
            ...
            self._m_entries = (self.entries_v50 if self.is_v50 else (self.entries_v40 if self.is_v40 else self.entries_v20))
            return getattr(self, '_m_entries', None)
        ...
        def is_v20(self):
            ...
            self._m_is_v20 = (True if self.section_contrib_version == 2 else False)
            return getattr(self, '_m_is_v20', None)
