...
params:
  - id: pdb_version
    doc: version from PDB information stream (index 1)
    type: u4
seq:
  - id: header
    type: debug_information_header
  - id: module_info
    type: 'module_infos(pdb_version, header.version_header)'
...
types:
  ...
  section_contribs:
    ...
    instances:
      is_v20:
        value: 'section_contrib_version == 2 ? true : false'
      is_v40:
        value: 'section_contrib_version == 4 ? true : false'
      is_v50:
        value: 'section_contrib_version == 5 ? true : false'
      entries:
        value: 'is_v50 ? entries_v50 : (is_v40 ? entries_v40 : entries_v20)'

  module_info_v20:
    doc: generated by Visual C++ 2.10/2.20
    seq:
  ...
  module_infos:
    ...
    instances:
      entries:
        value: 'is_v20 ? entries_v20 : (is_v50 ? entries_v50 : entries_v60)'
      is_v20:
        value: pdb_version <= 19941610
      is_v50:
        value: not is_v20 and (dbi_header_version < 19970606)
      is_v60:
        value: dbi_header_version >= 19970606
      section_contrib_version:
        value: 'is_v60 ? 5 : (is_v50 ? 4 : (is_v20 ? 2 : -1))'
