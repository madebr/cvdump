...
class CoffSymbolBaseType(enum.Enum):
...
class CoffSymbolComplexType(enum.Enum):
...
class CoffSymbolStorageClass(enum.Enum):
    """A special symbol that represents the end of function, for debugging purposes."""
    IMAGE_SYM_CLASS_END_OF_FUNCTION = -1  # (0xff)
...
class CoffRelocationI386(enum.Enum):
...
class CoffRelocationAMD64(enum.Enum):
    """The relocation is ignored."""
